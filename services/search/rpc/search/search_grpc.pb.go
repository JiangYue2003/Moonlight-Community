...
const (
	...
	Search_Suggest_FullMethodName = "/search.Search/Suggest"
)
...
func (c *searchClient) Suggest(ctx context.Context, in *SuggestReq, opts ...grpc.CallOption) (*SuggestResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuggestResp)
...
type SearchServer interface {
	...
	Suggest(context.Context, *SuggestReq) (*SuggestResp, error)
...
func (UnimplementedSearchServer) Suggest(context.Context, *SuggestReq) (*SuggestResp, error) {
