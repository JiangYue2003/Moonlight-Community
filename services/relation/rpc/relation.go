...
import (
	...
	relationServer "github.com/zhiguang/zhiguang-go/services/relation/rpc/internal/server/relation"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		relation.RegisterRelationServer(grpcServer, relationServer.NewRelationServer(ctx))
